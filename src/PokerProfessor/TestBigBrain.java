...
public class TestBigBrain {
	...
	public TestBigBrain(){
		pP[0]=new int[]{51,60,81,131,21,122,30};//High card
		...
		pP[4]=new int[]{91,110,132,130,101,121,130};;//straight
		pP[5]=new int[]{81,83,51,41,20,141,131};//flush
		pP[6]=new int[]{81,83,132,130,120,121,131};//fullhouse
		pP[7]=new int[]{122,123,132,130,120,121,131};//quads
		pP[8]=new int[]{91,111,132,130,101,121,131};//straight flush
